...
USER root
RUN echo "deb http://cdn-aws.deb.debian.org/debian/ buster main\ndeb http://cdn-aws.deb.debian.org/debian/ buster/updates main\ndeb http://cdn-aws.deb.debian.org/debian/ buster-updates main" > /etc/apt/sources.list.d/debian-nl.list
